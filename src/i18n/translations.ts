...
const translations: Record<string, Record<Locale, string>> = {
  ...
  // Prompt Engine
  "prompt.title": { en: "Prompt Engine", zh: "提示引擎" },
  "prompt.subtitle": { en: "Seedance 2.0 Script Generator", zh: "Seedance 2.0 脚本生成器" },
  "prompt.characterProfiles": { en: "Character Profiles", zh: "角色档案" },
  "prompt.addCharacter": { en: "Add Character", zh: "添加角色" },
  "prompt.charNamePlaceholder": { en: "Character name...", zh: "角色名称..." },
  "prompt.charDnaPlaceholder": { en: "Visual DNA description...", zh: "视觉DNA描述..." },
  "prompt.save": { en: "Save", zh: "保存" },
  "prompt.cancel": { en: "Cancel", zh: "取消" },
  "prompt.visualDna": { en: "Visual DNA", zh: "视觉DNA" },
  "prompt.editDna": { en: "Edit", zh: "编辑" },
  "prompt.saveDna": { en: "Save DNA", zh: "保存DNA" },
  "prompt.scriptGenerator": { en: "Script Generator", zh: "脚本生成器" },
  "prompt.wordsLabel": { en: "Words", zh: "单词" },
  "prompt.wordsPlaceholder": { en: "Enter words separated by commas or new lines...", zh: "输入单词，用逗号或换行分隔..." },
  "prompt.wordsHint": { en: "Separate words with commas or new lines", zh: "用逗号或换行分隔单词" },
  "prompt.activeCharacter": { en: "Active Character", zh: "当前角色" },
  "prompt.generateBtn": { en: "Generate Seedance Prompt", zh: "生成 Seedance 提示" },
  "prompt.generating": { en: "Generating...", zh: "正在生成..." },
  "prompt.generatedScripts": { en: "Generated Scripts", zh: "已生成脚本" },
  "prompt.clearAll": { en: "Clear All", zh: "清除全部" },
  "prompt.colWord": { en: "Word", zh: "单词" },
  "prompt.colCharacter": { en: "Character", zh: "角色" },
  "prompt.colSetting": { en: "Setting", zh: "场景" },
  "prompt.colPreview": { en: "Preview", zh: "预览" },
  "prompt.colActions": { en: "Actions", zh: "操作" },
  "prompt.copy": { en: "Copy", zh: "复制" },
  "prompt.copied": { en: "Copied!", zh: "已复制！" },
  "prompt.fullScript": { en: "Full Script", zh: "完整脚本" },
  "prompt.narratorLines": { en: "Narrator Lines", zh: "旁白台词" },
  "prompt.background": { en: "Background", zh: "背景" },
  "prompt.negPrompt": { en: "Negative Prompt", zh: "负面提示" },
  "prompt.exportAll": { en: "Export All", zh: "导出全部" },
  "prompt.emptyState": { en: "No scripts generated yet", zh: "尚未生成脚本" },
  "prompt.emptyHint": { en: "Select a character and word to get started", zh: "选择角色和单词开始" },
